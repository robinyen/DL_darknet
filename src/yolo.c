...
{
    char *train_images = "/home/paperspace/Project/yolo/darknet/VOC_data/2007_train.txt";
    char *backup_directory = "/home/paperspace/Project/yolo/darknet/backup/yolov1/";
    srand(time(0));
